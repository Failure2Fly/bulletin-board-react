...
export default function PostForm({showPost, postTitle, setShowPost}){ 
    ...
    if(showPost && postTitle === "LOST PET"){
        return (
            <LostPet setShowPost={setShowPost} postTitle={postTitle}/>
        );
    }
    if(showPost && postTitle === "LESSONS"){
        return (
            <Lessons setShowPost={setShowPost} postTitle={postTitle}/>
        );
    }
    if(showPost && postTitle === "CAR POOL"){
        return (
            <CarPool setShowPost={setShowPost} postTitle={postTitle}/>
        );
    }
    if(showPost && postTitle === "JOB POSTING"){
        return (
            <JobPosting setShowPost={setShowPost} postTitle={postTitle}/>
        );
    }
    if(showPost && postTitle === "SHIFT COVERAGE"){
        return (
            <ShiftCoverage setShowPost={setShowPost} postTitle={postTitle}/>
        );
    }
    if(showPost && postTitle === "SELLING-WANTED"){
        return (
            <SellWant setShowPost={setShowPost} postTitle={postTitle}/>
        );
    }
    if(showPost && postTitle === "VOLUNTEERS"){
        return (
            <Volunteers setShowPost={setShowPost} postTitle={postTitle}/>
        );
    }
    if(showPost && postTitle === "PARTY"){
        return (
            <Party setShowPost={setShowPost} postTitle={postTitle}/>
        );
    }
    ...
    if(showPost && postTitle === "PLAY GAMES"){
        return (
            <PlayGames setShowPost={setShowPost} postTitle={postTitle}/>
        );
    }
    else{
        return null;
